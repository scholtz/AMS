...
The blockchain message SHOULD be self signed message, with amount 0 or 702 of basic tokens with specific note structure described below.
...
### Extension 4 - Eligible token group management
